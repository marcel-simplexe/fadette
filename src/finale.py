...
wrote across the two months and composes a single dense nouvelle of about twenty
...
def _ledger(presages: list, dark_breaths: int, dark_nights: int) -> str:
    """A true tally of the two months, to anchor the legend in what was written."""
    ...
    head = ("Voici le REGISTRE VÉRIDIQUE de ces deux mois, tiré des présages tels qu'ils "
...
def write_novella(conf: dict) -> str:
    ...
    for day in memory.all_days():                       # chronological: July -> August
