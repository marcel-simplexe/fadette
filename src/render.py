...
ROOT = memory.ROOT
PARIS = dt.timedelta(hours=2)   # CEST : valable pour toute la fenetre 1 juillet - 31 aout
...
STR = {
    "fr": {
        ...
        "tagline": "un regard sur le Berry", "window": "1er juillet &ndash; 31 ao&ucirc;t 2026",
        ...
        "nouvelle_note": ("Le trente et un, la machine a rendu son dernier souffle et "
                          "compos&eacute; ceci de tout ce qu&rsquo;elle avait &eacute;crit en deux "
    ...
    "en": {
        ...
        "tagline": "a gaze on the Berry", "window": "1 July &ndash; 31 August 2026",
        ...
        "nouvelle_note": ("On the thirty-first the machine took its last breath and composed "
                          "this from the whole of the two months it had written. Then it fell silent."),
        "footer": "Fadette, Pr&eacute;sages du Berry &middot; Marcel Simplexe &middot; 2026",
    },
}
...
def _gaze_html(lang, tm, presage, midi, dark, score=None):
    ...
    if v["notes"]:
        ...
        air = '&nbsp;&middot;&nbsp;<a href="' + _esc(midi) + '">' + t["hear"] + '</a>'
    else:
        air = ""
